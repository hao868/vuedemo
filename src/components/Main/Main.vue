<template>
  <el-tabs type="border-card">
    <el-tab-pane label="附件列表" style="color:#1abc9c">
      <el-row style="margin-bottom:10px" v-if="select">
        <el-col :span='1.5'><el-button size='mini' @click="cancelSelect()">取消选中</el-button></el-col>
        <el-col :span='2'><el-button size='mini' type='danger' @click="deleteSelected()">删除所选</el-button></el-col>
      </el-row>
    ...
    <el-tab-pane label="添加">添加附件</el-tab-pane>
  </el-tabs>
</template>
...
export default {
  ...
  methods: {
    ...
    handleSelectionChange(val) {
      ...
      this.multipleSelection != '' ? this.select=true : this.select=false;
    },
    //取消选中
    cancelSelect(){
